/* ============================================================
   ORGANIZATION & PROJECT USER DIRECTORY
   Read-only Member Entitlement Management telemetry.
   Project blank  -> organization-wide users + all project access
   Project selected -> users with access to the selected project
   ============================================================ */
...
async function fetchUserDirectoryData() {
  ...
  try {
    ...
    // Newest activity first; users without a last-access timestamp stay at bottom.
